...
#Author: Roo79x
#Date: 14/05/2018
#Usage: bash upgcln.sh {-option}
# Options: -f Full update
##############################
...
sudo apt update && sudo apt upgrade && sudo apt dist-upgrade && sudo apt full-upgrade && sudo apt autoclean && sudo apt autoremove --purge
echo "   "

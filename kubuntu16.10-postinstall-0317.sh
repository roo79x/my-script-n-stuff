#!/bin/bash
#Title: Post install script for Kubuntu 16.10
...
# sudo apt-get autoremove --purge kwrite
# echo "   "
...
${txtrst}"
sudo apt install lame gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly 
gstreamer1.0-libav gstreamer1.0-fluendo-mp3 libdvdread4 oxideqt-codecs-extra 
libavcodec-extra libavcodec-extra57 ffmpeg aac-enc libav-tools mediainfo 
vorbis-tools opus-tools vpx-tools x264 x265 mkvtoolnix ffmpeg2theora sox 
libc6-i386 lib32gcc1 lib32stdc++6 gpac vlc vlc-plugin-samba
echo "   "
